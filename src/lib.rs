...
#[derive(Debug)]
pub struct LineaProofProcessor {
    verbose: bool,
    processed_count: usize,
}

impl LineaProofProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting LineaProof processing");
    
    let mut processor = LineaProofProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = LineaProofProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = LineaProofProcessor::new(false);
